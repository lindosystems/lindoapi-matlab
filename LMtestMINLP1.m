% LMtestMINLP1: Set up and solve the following nonlinear integer model using LINDO API's
%              multi-start nonlinear optimizer to solve relaxations. 
%
