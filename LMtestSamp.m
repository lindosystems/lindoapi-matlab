function [X,XCI,nErr] = LMtestSamp(szDistType,dPar,nSampSize,iVarControl,nSeed,nDim,nPrintLevel)
% LMtestSamp
% Test sampling routines in LINDO API.
% Usage: [nStatus] =LMtestSamp(szDistType,dPar,iVarControl,nSampSize,nSeed)
%
% INPUT (RHS)
...
%                 sample.
%   XCI           Correlation induced sample
%   nErr          Error code.
% Copyright (c) 2008
%
